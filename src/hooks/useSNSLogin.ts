...
export default function useSNSLogin() {
  ...
  useEffect(() => {
    window.addEventListener("loginKakao", (d) => kakaoLoginAndSign(d, "android"));
    window.addEventListener("loginNaver", (d) => naverLoginAndSign(d, "android"));
    window.loginKakaoIOS = (d: any) => kakaoLoginAndSign(d, "ios");
    window.loginAppleIOS = loginAppleLoginAndSign;
    return () => {
      window.removeEventListener("loginKakao", (d) => kakaoLoginAndSign(d, "android"));
      window.removeEventListener("loginNaver", (d) => naverLoginAndSign(d, "android"));
    };
  }, []);
